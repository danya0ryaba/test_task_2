    ...
    return (
        <div className={className}>
            <button
                disabled={disabled}
                onClick={onClick}
                className={`${style.button} ${style[typeView]}`}
                {...otherProps}
            >
                {children}
                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path opacity="0.5" d="M22.5779 11.3388C22.2614 11.0259 21.7521 11.0259 21.4356 11.3388L19.6088 13.1443C19.3745 13.3759 19.3032 13.7261 19.4284 14.0309C19.5536 14.3357 19.8505 14.5347 20.18 14.5347H21.154C20.741 18.6833 17.1989 21.9375 12.873 21.9375C9.85862 21.9375 7.22136 20.3561 5.76113 17.9899C5.52547 17.6081 5.02486 17.4895 4.64299 17.7252C4.26112 17.9609 4.1426 18.4615 4.37826 18.8433C6.12525 21.6742 9.27774 23.5625 12.873 23.5625C18.0815 23.5625 22.3681 19.5966 22.7859 14.5347H23.8335C24.163 14.5347 24.4599 14.3357 24.5851 14.0309C24.7103 13.7261 24.639 13.3759 24.4047 13.1443L22.5779 11.3388Z" fill="white" />
                </svg>
            </button>
        </div>
    )
